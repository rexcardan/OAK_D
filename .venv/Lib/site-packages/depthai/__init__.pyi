...
class CalibrationHandler:
    ...
    def getCameraIntrinsics(self, cameraId: CameraBoardSocket, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x00000259A6A2E6F0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x00000259A6A2E6B0>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        2. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x00000259A6A2E670>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x00000259A6A2E630>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        3. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x00000259A6A2E5F0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x00000259A6A2E5B0>, keepAspectRatio: bool = True) -> list[list[float]]
